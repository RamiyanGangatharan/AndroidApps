...
/**
 * The SDB_Driver class provides utility methods to convert between decimal and binary number systems.
 */
public class SDB_Driver
{
    /**
     * Converts a string or decimal number to its binary representation.
     *
    ...
    public static String decimalToBinary(int decimalNumber)
    {
        ...
        // Build the binary string from the remainders
